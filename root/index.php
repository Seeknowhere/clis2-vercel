...
<head>
    <meta charset="utf-8">
    <title>404 - Clinical Laboratory Information System</title>

	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <meta name="apple-mobile-web-app-capable" content="yes"> 
	    
	<link href="<?php echo root_url()?>assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
...
<body>
	...
	<div class="navbar-inner">
		...
		<div class="container">
			...
			<a class="brand" href="<?php echo root_url()?>system/dashboard">
			...
			<div class="nav-collapse">
				<ul class="nav pull-right">
					...
					<li class="">						
						<a href="<?php echo root_url()?>system/dashboard" class="">
		...
		<div class="span12">
			...
			<div class="error-container">
				...
				<div class="error-details">
					Sorry, an error has occured! Why not try going back to the dashboard!
					
				</div> <!-- /error-details -->
				
				<div class="error-actions">
					<a href="<?php echo root_url()?>system/dashboard" class="btn btn-large btn-primary">
						<i class="icon-chevron-left"></i>
						&nbsp;
						Back to Dashboard						
					</a>
