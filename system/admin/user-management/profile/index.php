            ...
            <div class="row">
              <div class="span3">
                <div id="user_profile_update_picture">
                  ...
                  <img src="<?php echo root_url()?>/assets/img/user/<?php echo @$user_account->Image_file?>" width="250" alt="user" style="border: solid 1px black; padding: 5px;">
              ...
              <div class="span4" style="margin-left:5%;">
                <div class="control-group">											
                  ...
                  <div class="controls">
                    <input type="text" class="span4 " id="user_profile_update_status" style="color: <?echo (@$user_account->Active==1)? "green" : "red"?>; font-weight:bold;"value="<?echo (@$user_account->Active==1)? "ACTIVE" : "DEACTIVATED -  ".date("F j, Y  g:i A", strtotime(@$user_account->Datetime_deactivated))?>" readonly>
                  </div> <!-- /controls -->				  
                </div> <!-- /control-group -->
              ...
              <div class="control-group">											
                ...
                <button class="btn btn-<?echo (@$user_account->Active==0)? "success" : "danger"?> pull-left" id="user_deactivition"><i class="fa fa-<?echo (@$user_account->Active==0)? "check" : "ban"?>"></i>  <?echo (@$user_account->Active==0)? "ACTIVATE" : "DEACTIVATED"?> </button>
