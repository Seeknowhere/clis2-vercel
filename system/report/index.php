<?php 
    ...
    include_once($_SERVER['DOCUMENT_ROOT'].'/clis/system/report/service.php');
?>
<?php 
    main_header();
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="container">
              <div class="row">
                ...
                <div class="control-group span3 ">			
                  ...
                  <div class="control-group span3">											
                    ...
                    <div class="controls ">
                      <input type="date" class=" " id="generate_total_sales_date_to" value="<?php echo date('Y-m-d'); ?>" placeholder="Enter a date to">
                    </div> <!-- /controls -->				
                  </div> <!-- /control-group -->  
            ...
            <div class="widget" id="lab_test_total_sales" hidden>
              <div class="widget-header">
                <i class="icon-list-alt"></i>
                <h3>GENERATE LAB TEST TOTAL SALES</h3>
